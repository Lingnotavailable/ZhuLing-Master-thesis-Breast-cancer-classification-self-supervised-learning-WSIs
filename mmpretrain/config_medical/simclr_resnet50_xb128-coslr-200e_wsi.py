...
optim_wrapper = dict(
    optimizer=dict(lr=2e-2, momentum=0.9, type='LARS', weight_decay=1e-05),
    paramwise_cfg=dict(
        custom_keys=dict({
...
param_scheduler = [
    dict(
        ...
        type='LinearLR'),
    dict(
        T_max=190, begin=10, by_epoch=True, end=200, type='CosineAnnealingLR'),
]
