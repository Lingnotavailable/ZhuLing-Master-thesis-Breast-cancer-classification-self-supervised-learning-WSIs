...
init_cfg = dict(checkpoint='weight/wsi_simclr_pretrained_2.pth', type='Pretrained')
lr = 1e-3
max_epochs = 200
...
launcher = 'none'
load_from = '/root/autodl-tmp/mmpretrain/work_dirs/resnet50_b256_wsi_Dataset100/epoch_100.pth'
log_level = 'INFO'