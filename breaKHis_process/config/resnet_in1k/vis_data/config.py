...
init_cfg = dict(checkpoint='weight/in1k_pretrained.pth', type='Pretrained')
launcher = 'none'
load_from = None
log_level = 'INFO'
lr = 0.0001
...
model = dict(
    backbone=dict(
        depth=50,
        init_cfg=dict(
            checkpoint='weight/in1k_pretrained.pth', type='Pretrained'),
        num_stages=4,
        out_indices=(3, ),
        style='pytorch',
        type='ResNet'),
...
work_dir = './work_dirs/resnet50_b96_in1k_Dataset100'
