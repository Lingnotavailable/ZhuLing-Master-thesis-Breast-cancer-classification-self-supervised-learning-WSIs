...
init_cfg = dict(
    checkpoint='weight/wsi_simclr_pretrained_3.pth', type='Pretrained')
launcher = 'none'
load_from = None
log_level = 'INFO'
lr = 0.0001
...
model = dict(
    backbone=dict(
        depth=50,
        init_cfg=dict(
            checkpoint='weight/wsi_simclr_pretrained_3.pth',
            type='Pretrained'),
        num_stages=4,
        out_indices=(3, ),
        style='pytorch',
...
work_dir = './work_dirs/resnet50_b96_wsi_Dataset100_3'
